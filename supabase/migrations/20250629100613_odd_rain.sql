/*
  ...
  2. Create profiles, tasks, and task_shares tables
  3. Set up all RLS policies and triggers
  4. Create your user profile automatically
  5. Add all necessary indexes for performance
*/
...
-- Create your user profile (since you're already authenticated)
DO $$
BEGIN
  -- Try to get the current user's info from auth.users
